...
\textit{In der Option nach dem \texttt{sed} - Kommando müssen doppelte Anführungszeichen gesetzt werden, damit der Inhalt der Variablen \texttt{EXTENSION} ausgegeben wird.}
